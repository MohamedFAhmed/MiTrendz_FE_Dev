...
(function ($, window) {
    ...
    lazyloadClass = function (els, options) {
        var elements = els;
        var settings = {
            newelements: null,
            threshold: 10,
        ...
        function update() {
            ...
            settings.newelements.forEach(function () {
                var $this = $(this);
                var elementy = $this.y;
                if ((scrolltop + viewHeight) >= elementy - 100) {
    ...
    $.fn.lazyload = function (options) {
        ...
        var instance = new lazyloadClass(this, options);
